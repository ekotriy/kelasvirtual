        ...
        <div class="row">
            <div class="col-lg">
                <div class="p-5">
                    ...
                    <form class="user" method="post" action="<?= base_url('auth/registerdosen'); ?>">
                    ...
                    <hr>
                    <div class="text-center">
                        <a class="small text-secondary" href="<?= base_url('auth/lupapassword'); ?>">Lupa Password</a>
                    </div>
                    <div class="text-center">
                        <a class="small text-secondary" href="<?= base_url('auth'); ?>">Sudah punya akun ? Login</a>
                    </div>
                    <div class="text-center">
                        <a class="small text-secondary" href="<?= base_url('auth/register'); ?>">Daftar sebagai mahasiswa</a>
                    </div>
                </div>
            </div>
        </div>
